...
public class Filter {
    public ObservableList<NewCar> usernameFilter(String username, ObservableList<NewCar> list) {
        if(!username.isEmpty()) {
    ...
    public ObservableList<NewCar> nameFilter(String name, ObservableList<NewCar> list) {
        if(!name.isEmpty()) {
    ...
    public ObservableList<NewCar> fuelFilter(String fuel, ObservableList<NewCar> list) {
        if(!fuel.isEmpty()) {
    ...
    public ObservableList<NewCar> wheelsFilter(String wheels, ObservableList<NewCar> list) {
        if(!wheels.isEmpty()) {
    ...
    public ObservableList<NewCar> colorFilter(String color, ObservableList<NewCar> list) {
        if(!color.isEmpty()) {
    ...
    public ObservableList<NewCar> addonFilter(String addon, ObservableList<NewCar> list, int i) {
        if(!addon.isEmpty()) {
